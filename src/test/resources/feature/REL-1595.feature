@ST_86074 @tagtagtag @this_is_story_tag
...
@SC_378966 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_378967 @third_scenario_tag
...
@SC_378968 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_378969 @fifth_scenario_tag
