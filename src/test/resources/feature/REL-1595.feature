@ST_71962 @tagtagtag @this_is_story_tag
...
@SC_323787 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_323788 @third_scenario_tag
...
@SC_323789 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_323790 @fifth_scenario_tag
