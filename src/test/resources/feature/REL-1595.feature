@ST_83879 @tagtagtag @this_is_story_tag
...
@SC_369739 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_369740 @third_scenario_tag
...
@SC_369741 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_369742 @fifth_scenario_tag
