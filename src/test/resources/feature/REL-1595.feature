@ST_56395 @tagtagtag @this_is_story_tag
...
@SC_264092 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_264093 @third_scenario_tag
...
@SC_264094 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_264095 @fifth_scenario_tag
