@ST_47568 @tagtagtag @this_is_story_tag
...
@SC_228511 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_228512 @third_scenario_tag
...
@SC_228513 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_228514 @fifth_scenario_tag
