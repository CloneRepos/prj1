@ST_102825 @tagtagtag @this_is_story_tag
...
@SC_444866 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_444867 @third_scenario_tag
...
@SC_444868 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_444869 @fifth_scenario_tag
