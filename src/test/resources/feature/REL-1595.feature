@ST_69163 @tagtagtag @this_is_story_tag
...
@SC_312722 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_312723 @third_scenario_tag
...
@SC_312724 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_312725 @fifth_scenario_tag
