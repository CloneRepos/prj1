@ST_101269 @tagtagtag @this_is_story_tag
...
@SC_438774 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_438775 @third_scenario_tag
...
@SC_438776 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_438777 @fifth_scenario_tag
