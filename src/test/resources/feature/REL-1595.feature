@ST_119025 @tagtagtag @this_is_story_tag
...
@SC_506962 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_506963 @third_scenario_tag
...
@SC_506964 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_506965 @fifth_scenario_tag
