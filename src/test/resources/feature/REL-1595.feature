@ST_107232 @tagtagtag @this_is_story_tag
...
@SC_460940 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_460941 @third_scenario_tag
...
@SC_460942 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_460943 @fifth_scenario_tag
