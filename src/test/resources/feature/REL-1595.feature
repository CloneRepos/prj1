@ST_110785 @tagtagtag @this_is_story_tag
...
@SC_474494 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_474495 @third_scenario_tag
...
@SC_474496 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_474497 @fifth_scenario_tag
