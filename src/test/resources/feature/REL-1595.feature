@ST_117984 @tagtagtag @this_is_story_tag
...
@SC_502865 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_502866 @third_scenario_tag
...
@SC_502867 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_502868 @fifth_scenario_tag
