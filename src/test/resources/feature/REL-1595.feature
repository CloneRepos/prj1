@ST_43521 @tagtagtag @this_is_story_tag
...
@SC_212299 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_212300 @third_scenario_tag
...
@SC_212301 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_212302 @fifth_scenario_tag
