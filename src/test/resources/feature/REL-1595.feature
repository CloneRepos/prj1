@ST_12481 @tagtagtag @this_is_story_tag
...
@SC_81475 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_81476 @third_scenario_tag
...
@SC_81477 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_81478 @fifth_scenario_tag
