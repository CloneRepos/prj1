@ST_95025 @tagtagtag @this_is_story_tag
...
@SC_414255 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_414256 @third_scenario_tag
...
@SC_414257 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_414258 @fifth_scenario_tag
