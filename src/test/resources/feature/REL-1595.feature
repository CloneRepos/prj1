@ST_74909 @tagtagtag @this_is_story_tag
...
@SC_335497 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_335498 @third_scenario_tag
...
@SC_335499 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_335500 @fifth_scenario_tag
