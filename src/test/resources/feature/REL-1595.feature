@ST_34380 @tagtagtag @this_is_story_tag
...
@SC_177141 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_177142 @third_scenario_tag
...
@SC_177143 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_177144 @fifth_scenario_tag
