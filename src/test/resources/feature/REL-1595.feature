@ST_97623 @tagtagtag @this_is_story_tag
...
@SC_424444 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_424445 @third_scenario_tag
...
@SC_424446 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_424447 @fifth_scenario_tag
