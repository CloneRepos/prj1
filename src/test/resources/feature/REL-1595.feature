@ST_92087 @tagtagtag @this_is_story_tag
...
@SC_403539 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_403540 @third_scenario_tag
...
@SC_403541 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_403542 @fifth_scenario_tag
