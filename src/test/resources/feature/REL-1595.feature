@ST_76121 @tagtagtag @this_is_story_tag
...
@SC_340269 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_340270 @third_scenario_tag
...
@SC_340271 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_340272 @fifth_scenario_tag
