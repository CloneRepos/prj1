@ST_28617 @tagtagtag @this_is_story_tag
...
@SC_151862 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_151863 @third_scenario_tag
...
@SC_151864 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_151865 @fifth_scenario_tag
