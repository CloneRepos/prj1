@ST_120067 @tagtagtag @this_is_story_tag
...
@SC_511060 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_511061 @third_scenario_tag
...
@SC_511062 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_511063 @fifth_scenario_tag
