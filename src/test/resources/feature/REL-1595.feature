@ST_44682 @tagtagtag @this_is_story_tag
...
@SC_217422 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_217423 @third_scenario_tag
...
@SC_217424 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_217425 @fifth_scenario_tag
