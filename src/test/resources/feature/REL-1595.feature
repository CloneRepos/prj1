@ST_36870 @tagtagtag @this_is_story_tag
...
@SC_184639 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_184640 @third_scenario_tag
...
@SC_184641 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_184642 @fifth_scenario_tag
