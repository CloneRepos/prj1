@ST_70007 @tagtagtag @this_is_story_tag
...
@SC_316590 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_316591 @third_scenario_tag
...
@SC_316592 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_316593 @fifth_scenario_tag
