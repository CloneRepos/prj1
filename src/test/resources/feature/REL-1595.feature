@ST_69027 @tagtagtag @this_is_story_tag
...
@SC_312466 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_312467 @third_scenario_tag
...
@SC_312468 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_312469 @fifth_scenario_tag
