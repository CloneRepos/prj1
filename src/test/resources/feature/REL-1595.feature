@ST_8834 @tagtagtag @this_is_story_tag
...
@SC_61204 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_61205 @third_scenario_tag
...
@SC_61206 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_61207 @fifth_scenario_tag
