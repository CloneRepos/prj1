@ST_62464 @tagtagtag @this_is_story_tag
...
@SC_286246 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_286247 @third_scenario_tag
...
@SC_286248 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_286249 @fifth_scenario_tag
