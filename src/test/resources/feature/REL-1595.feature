@ST_100749 @tagtagtag @this_is_story_tag
...
@SC_436738 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_436739 @third_scenario_tag
...
@SC_436740 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_436741 @fifth_scenario_tag
