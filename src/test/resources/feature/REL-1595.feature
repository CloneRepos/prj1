@ST_60986 @tagtagtag @this_is_story_tag
...
@SC_280782 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_280783 @third_scenario_tag
...
@SC_280784 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_280785 @fifth_scenario_tag
