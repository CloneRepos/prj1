@ST_103346 @tagtagtag @this_is_story_tag
...
@SC_446915 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_446916 @third_scenario_tag
...
@SC_446917 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_446918 @fifth_scenario_tag
