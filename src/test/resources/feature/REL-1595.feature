@ST_89489 @tagtagtag @this_is_story_tag
...
@SC_393362 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_393363 @third_scenario_tag
...
@SC_393364 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_393365 @fifth_scenario_tag
