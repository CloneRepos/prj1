@ST_14960 @tagtagtag @this_is_story_tag
...
@SC_96954 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_96955 @third_scenario_tag
...
@SC_96956 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_96957 @fifth_scenario_tag
