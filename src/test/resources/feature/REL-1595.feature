@ST_29439 @tagtagtag @this_is_story_tag
...
@SC_155627 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_155628 @third_scenario_tag
...
@SC_155629 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_155630 @fifth_scenario_tag
