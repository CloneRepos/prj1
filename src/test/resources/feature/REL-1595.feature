@ST_49663 @tagtagtag @this_is_story_tag
...
@SC_236403 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_236404 @third_scenario_tag
...
@SC_236405 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_236406 @fifth_scenario_tag
