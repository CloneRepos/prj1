@ST_116943 @tagtagtag @this_is_story_tag
...
@SC_498768 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_498769 @third_scenario_tag
...
@SC_498770 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_498771 @fifth_scenario_tag
