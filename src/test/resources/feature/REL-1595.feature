@ST_61576 @tagtagtag @this_is_story_tag
...
@SC_282668 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_282669 @third_scenario_tag
...
@SC_282670 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_282671 @fifth_scenario_tag
