@ST_48713 @tagtagtag @this_is_story_tag
...
@SC_233038 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_233039 @third_scenario_tag
...
@SC_233040 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_233041 @fifth_scenario_tag
