@ST_108274 @tagtagtag @this_is_story_tag
...
@SC_465038 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_465039 @third_scenario_tag
...
@SC_465040 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_465041 @fifth_scenario_tag
