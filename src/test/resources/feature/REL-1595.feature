@ST_12821 @tagtagtag @this_is_story_tag
...
@SC_82423 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_82424 @third_scenario_tag
...
@SC_82425 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_82426 @fifth_scenario_tag
