@ST_106284 @tagtagtag @this_is_story_tag
...
@SC_457631 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_457632 @third_scenario_tag
...
@SC_457633 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_457634 @fifth_scenario_tag
