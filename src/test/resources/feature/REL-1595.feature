@ST_33532 @tagtagtag @this_is_story_tag
...
@SC_173886 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_173887 @third_scenario_tag
...
@SC_173888 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_173889 @fifth_scenario_tag
