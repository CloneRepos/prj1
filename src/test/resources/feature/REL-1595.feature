@ST_11050 @tagtagtag @this_is_story_tag
...
@SC_73006 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_73007 @third_scenario_tag
...
@SC_73008 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_73009 @fifth_scenario_tag
