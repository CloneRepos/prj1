@ST_90524 @tagtagtag @this_is_story_tag
...
@SC_397392 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_397393 @third_scenario_tag
...
@SC_397394 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_397395 @fifth_scenario_tag
