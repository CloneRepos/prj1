@ST_97102 @tagtagtag @this_is_story_tag
...
@SC_422395 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_422396 @third_scenario_tag
...
@SC_422397 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_422398 @fifth_scenario_tag
