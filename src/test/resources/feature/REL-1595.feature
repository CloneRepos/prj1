@ST_67657 @tagtagtag @this_is_story_tag
...
@SC_306924 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_306925 @third_scenario_tag
...
@SC_306926 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_306927 @fifth_scenario_tag
