@ST_68832 @tagtagtag @this_is_story_tag
...
@SC_311791 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_311792 @third_scenario_tag
...
@SC_311793 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_311794 @fifth_scenario_tag
