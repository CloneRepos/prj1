@ST_109837 @tagtagtag @this_is_story_tag
...
@SC_471185 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_471186 @third_scenario_tag
...
@SC_471187 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_471188 @fifth_scenario_tag
