@ST_78190 @tagtagtag @this_is_story_tag
...
@SC_347664 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_347665 @third_scenario_tag
...
@SC_347666 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_347667 @fifth_scenario_tag
