@ST_67948 @tagtagtag @this_is_story_tag
...
@SC_307928 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_307929 @third_scenario_tag
...
@SC_307930 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_307931 @fifth_scenario_tag
