@ST_85553 @tagtagtag @this_is_story_tag
...
@SC_376917 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_376918 @third_scenario_tag
...
@SC_376919 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_376920 @fifth_scenario_tag
