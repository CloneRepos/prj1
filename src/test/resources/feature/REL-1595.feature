@ST_32081 @tagtagtag @this_is_story_tag
...
@SC_168718 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_168719 @third_scenario_tag
...
@SC_168720 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_168721 @fifth_scenario_tag
