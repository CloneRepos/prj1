@ST_92608 @tagtagtag @this_is_story_tag
...
@SC_405588 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_405589 @third_scenario_tag
...
@SC_405590 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_405591 @fifth_scenario_tag
