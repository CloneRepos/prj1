@ST_52900 @tagtagtag @this_is_story_tag
...
@SC_251020 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_251021 @third_scenario_tag
...
@SC_251022 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_251023 @fifth_scenario_tag
