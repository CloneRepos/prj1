@ST_72490 @tagtagtag @this_is_story_tag
...
@SC_325892 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_325893 @third_scenario_tag
...
@SC_325894 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_325895 @fifth_scenario_tag
