@ST_90003 @tagtagtag @this_is_story_tag
...
@SC_395343 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_395344 @third_scenario_tag
...
@SC_395345 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_395346 @fifth_scenario_tag
