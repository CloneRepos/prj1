@ST_114338 @tagtagtag @this_is_story_tag
...
@SC_488523 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_488524 @third_scenario_tag
...
@SC_488525 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_488526 @fifth_scenario_tag
