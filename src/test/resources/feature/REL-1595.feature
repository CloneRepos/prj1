@ST_115380 @tagtagtag @this_is_story_tag
...
@SC_492621 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_492622 @third_scenario_tag
...
@SC_492623 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_492624 @fifth_scenario_tag
