@ST_57300 @tagtagtag @this_is_story_tag
...
@SC_267247 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_267248 @third_scenario_tag
...
@SC_267249 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_267250 @fifth_scenario_tag
