@ST_91566 @tagtagtag @this_is_story_tag
...
@SC_401490 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_401491 @third_scenario_tag
...
@SC_401492 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_401493 @fifth_scenario_tag
