@ST_70777 @tagtagtag @this_is_story_tag
...
@SC_319832 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_319833 @third_scenario_tag
...
@SC_319834 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_319835 @fifth_scenario_tag
