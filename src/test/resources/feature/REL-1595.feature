@ST_62006 @tagtagtag @this_is_story_tag
...
@SC_284066 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_284067 @third_scenario_tag
...
@SC_284068 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_284069 @fifth_scenario_tag
