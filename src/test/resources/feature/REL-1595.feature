@ST_113296 @tagtagtag @this_is_story_tag
...
@SC_484425 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_484426 @third_scenario_tag
...
@SC_484427 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_484428 @fifth_scenario_tag
