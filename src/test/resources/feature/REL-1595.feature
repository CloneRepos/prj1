@ST_42301 @tagtagtag @this_is_story_tag
...
@SC_207336 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_207337 @third_scenario_tag
...
@SC_207338 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_207339 @fifth_scenario_tag
