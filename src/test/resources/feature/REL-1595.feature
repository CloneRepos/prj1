@ST_78883 @tagtagtag @this_is_story_tag
...
@SC_350485 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_350486 @third_scenario_tag
...
@SC_350487 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_350488 @fifth_scenario_tag
