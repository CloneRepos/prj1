@ST_124228 @tagtagtag @this_is_story_tag
...
@SC_527396 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_527397 @third_scenario_tag
...
@SC_527398 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_527399 @fifth_scenario_tag
