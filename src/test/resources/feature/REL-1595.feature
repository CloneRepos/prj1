@ST_74191 @tagtagtag @this_is_story_tag
...
@SC_332513 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_332514 @third_scenario_tag
...
@SC_332515 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_332516 @fifth_scenario_tag
