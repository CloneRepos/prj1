@ST_94598 @tagtagtag @this_is_story_tag
...
@SC_412995 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_412996 @third_scenario_tag
...
@SC_412997 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_412998 @fifth_scenario_tag
