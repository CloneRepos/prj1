@ST_82549 @tagtagtag @this_is_story_tag
...
@SC_364398 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_364399 @third_scenario_tag
...
@SC_364400 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_364401 @fifth_scenario_tag
