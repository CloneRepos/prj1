@ST_98144 @tagtagtag @this_is_story_tag
...
@SC_426493 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_426494 @third_scenario_tag
...
@SC_426495 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_426496 @fifth_scenario_tag
