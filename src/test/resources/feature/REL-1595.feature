@ST_44071 @tagtagtag @this_is_story_tag
...
@SC_214476 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_214477 @third_scenario_tag
...
@SC_214478 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_214479 @fifth_scenario_tag
