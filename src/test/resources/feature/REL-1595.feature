@ST_111738 @tagtagtag @this_is_story_tag
...
@SC_478278 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_478279 @third_scenario_tag
...
@SC_478280 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_478281 @fifth_scenario_tag
