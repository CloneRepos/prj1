@ST_121623 @tagtagtag @this_is_story_tag
...
@SC_517151 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_517152 @third_scenario_tag
...
@SC_517153 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_517154 @fifth_scenario_tag
