@ST_35167 @tagtagtag @this_is_story_tag
...
@SC_179591 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_179592 @third_scenario_tag
...
@SC_179593 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_179594 @fifth_scenario_tag
