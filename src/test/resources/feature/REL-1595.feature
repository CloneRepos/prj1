@ST_58420 @tagtagtag @this_is_story_tag
...
@SC_271293 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_271294 @third_scenario_tag
...
@SC_271295 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_271296 @fifth_scenario_tag
