@ST_49219 @tagtagtag @this_is_story_tag
...
@SC_234610 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_234611 @third_scenario_tag
...
@SC_234612 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_234613 @fifth_scenario_tag
