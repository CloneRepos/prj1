@ST_96581 @tagtagtag @this_is_story_tag
...
@SC_420346 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_420347 @third_scenario_tag
...
@SC_420348 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_420349 @fifth_scenario_tag
