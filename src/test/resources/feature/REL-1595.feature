@ST_68239 @tagtagtag @this_is_story_tag
...
@SC_308932 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_308933 @third_scenario_tag
...
@SC_308934 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_308935 @fifth_scenario_tag
