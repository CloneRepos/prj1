@ST_87814 @tagtagtag @this_is_story_tag
...
@SC_386214 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_386215 @third_scenario_tag
...
@SC_386216 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_386217 @fifth_scenario_tag
