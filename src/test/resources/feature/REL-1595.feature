@ST_36021 @tagtagtag @this_is_story_tag
...
@SC_182115 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_182116 @third_scenario_tag
...
@SC_182117 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_182118 @fifth_scenario_tag
