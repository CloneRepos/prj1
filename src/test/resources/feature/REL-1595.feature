@ST_109316 @tagtagtag @this_is_story_tag
...
@SC_469136 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_469137 @third_scenario_tag
...
@SC_469138 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_469139 @fifth_scenario_tag
