@ST_17106 @tagtagtag @this_is_story_tag
...
@SC_108267 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_108268 @third_scenario_tag
...
@SC_108269 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_108270 @fifth_scenario_tag
