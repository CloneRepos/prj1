@ST_80951 @tagtagtag @this_is_story_tag
...
@SC_357928 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_357929 @third_scenario_tag
...
@SC_357930 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_357931 @fifth_scenario_tag
