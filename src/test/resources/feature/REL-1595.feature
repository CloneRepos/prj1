@ST_63738 @tagtagtag @this_is_story_tag
...
@SC_290331 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_290332 @third_scenario_tag
...
@SC_290333 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_290334 @fifth_scenario_tag
