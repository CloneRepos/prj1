@ST_41784 @tagtagtag @this_is_story_tag
...
@SC_205323 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_205324 @third_scenario_tag
...
@SC_205325 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_205326 @fifth_scenario_tag
