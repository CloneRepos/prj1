@ST_69425 @tagtagtag @this_is_story_tag
...
@SC_313729 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_313730 @third_scenario_tag
...
@SC_313731 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_313732 @fifth_scenario_tag
