@ST_104388 @tagtagtag @this_is_story_tag
...
@SC_451013 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_451014 @third_scenario_tag
...
@SC_451015 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_451016 @fifth_scenario_tag
