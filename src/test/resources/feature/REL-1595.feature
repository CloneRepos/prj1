@ST_48089 @tagtagtag @this_is_story_tag
...
@SC_230561 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_230562 @third_scenario_tag
...
@SC_230563 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_230564 @fifth_scenario_tag
