@ST_64165 @tagtagtag @this_is_story_tag
...
@SC_291591 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_291592 @third_scenario_tag
...
@SC_291593 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_291594 @fifth_scenario_tag
