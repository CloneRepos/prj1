@ST_125169 @tagtagtag @this_is_story_tag
...
@SC_530649 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_530650 @third_scenario_tag
...
@SC_530651 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_530652 @fifth_scenario_tag
