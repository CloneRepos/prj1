@ST_87115 @tagtagtag @this_is_story_tag
...
@SC_383063 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_383064 @third_scenario_tag
...
@SC_383065 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_383066 @fifth_scenario_tag
