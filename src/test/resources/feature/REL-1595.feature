@ST_58963 @tagtagtag @this_is_story_tag
...
@SC_273573 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_273574 @third_scenario_tag
...
@SC_273575 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_273576 @fifth_scenario_tag
