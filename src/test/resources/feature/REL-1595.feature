@ST_77246 @tagtagtag @this_is_story_tag
...
@SC_344315 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_344316 @third_scenario_tag
...
@SC_344317 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_344318 @fifth_scenario_tag
