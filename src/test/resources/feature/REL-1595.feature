@ST_42818 @tagtagtag @this_is_story_tag
...
@SC_209422 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_209423 @third_scenario_tag
...
@SC_209424 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_209425 @fifth_scenario_tag
