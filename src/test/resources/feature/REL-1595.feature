@ST_83351 @tagtagtag @this_is_story_tag
...
@SC_367634 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_367635 @third_scenario_tag
...
@SC_367636 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_367637 @fifth_scenario_tag
