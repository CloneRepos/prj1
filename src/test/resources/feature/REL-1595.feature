@ST_100228 @tagtagtag @this_is_story_tag
...
@SC_434689 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_434690 @third_scenario_tag
...
@SC_434691 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_434692 @fifth_scenario_tag
