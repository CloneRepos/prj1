@ST_88454 @tagtagtag @this_is_story_tag
...
@SC_389319 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_389320 @third_scenario_tag
...
@SC_389321 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_389322 @fifth_scenario_tag
