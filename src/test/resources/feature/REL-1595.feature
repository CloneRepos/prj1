@ST_99707 @tagtagtag @this_is_story_tag
...
@SC_432640 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_432641 @third_scenario_tag
...
@SC_432642 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_432643 @fifth_scenario_tag
