@ST_71534 @tagtagtag @this_is_story_tag
...
@SC_322522 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_322523 @third_scenario_tag
...
@SC_322524 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_322525 @fifth_scenario_tag
