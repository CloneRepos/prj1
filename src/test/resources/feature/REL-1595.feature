@ST_85032 @tagtagtag @this_is_story_tag
...
@SC_374868 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_374869 @third_scenario_tag
...
@SC_374870 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_374871 @fifth_scenario_tag
