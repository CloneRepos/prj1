@ST_35589 @tagtagtag @this_is_story_tag
...
@SC_180850 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_180851 @third_scenario_tag
...
@SC_180852 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_180853 @fifth_scenario_tag
