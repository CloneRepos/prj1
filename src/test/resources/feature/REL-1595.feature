@ST_40094 @tagtagtag @this_is_story_tag
...
@SC_198227 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_198228 @third_scenario_tag
...
@SC_198229 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_198230 @fifth_scenario_tag
