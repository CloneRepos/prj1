@ST_95546 @tagtagtag @this_is_story_tag
...
@SC_416304 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_416305 @third_scenario_tag
...
@SC_416306 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_416307 @fifth_scenario_tag
