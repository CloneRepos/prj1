@ST_56215 @tagtagtag @this_is_story_tag
...
@SC_263768 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_263769 @third_scenario_tag
...
@SC_263770 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_263771 @fifth_scenario_tag
