@ST_105857 @tagtagtag @this_is_story_tag
...
@SC_456371 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_456372 @third_scenario_tag
...
@SC_456373 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_456374 @fifth_scenario_tag
