@ST_56568 @tagtagtag @this_is_story_tag
...
@SC_264412 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_264413 @third_scenario_tag
...
@SC_264414 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_264415 @fifth_scenario_tag
