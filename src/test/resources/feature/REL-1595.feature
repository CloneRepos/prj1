@ST_111306 @tagtagtag @this_is_story_tag
...
@SC_476543 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_476544 @third_scenario_tag
...
@SC_476545 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_476546 @fifth_scenario_tag
