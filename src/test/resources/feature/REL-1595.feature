@ST_108795 @tagtagtag @this_is_story_tag
...
@SC_467087 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_467088 @third_scenario_tag
...
@SC_467089 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_467090 @fifth_scenario_tag
