@ST_11704 @tagtagtag @this_is_story_tag
...
@SC_78114 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_78115 @third_scenario_tag
...
@SC_78116 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_78117 @fifth_scenario_tag
