@ST_38291 @tagtagtag @this_is_story_tag
...
@SC_189670 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_189671 @third_scenario_tag
...
@SC_189672 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_189673 @fifth_scenario_tag
