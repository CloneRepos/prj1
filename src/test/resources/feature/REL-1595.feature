@ST_13307 @tagtagtag @this_is_story_tag
...
@SC_84936 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_84937 @third_scenario_tag
...
@SC_84938 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_84939 @fifth_scenario_tag
