@ST_76548 @tagtagtag @this_is_story_tag
...
@SC_341529 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_341530 @third_scenario_tag
...
@SC_341531 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_341532 @fifth_scenario_tag
