@ST_61256 @tagtagtag @this_is_story_tag
...
@SC_282356 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_282357 @third_scenario_tag
...
@SC_282358 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_282359 @fifth_scenario_tag
