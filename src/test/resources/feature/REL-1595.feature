@ST_71075 @tagtagtag @this_is_story_tag
...
@SC_320892 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_320893 @third_scenario_tag
...
@SC_320894 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_320895 @fifth_scenario_tag
