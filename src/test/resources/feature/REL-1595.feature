@ST_50342 @tagtagtag @this_is_story_tag
...
@SC_238603 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_238604 @third_scenario_tag
...
@SC_238605 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_238606 @fifth_scenario_tag
