@ST_34823 @tagtagtag @this_is_story_tag
...
@SC_178590 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_178591 @third_scenario_tag
...
@SC_178592 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_178593 @fifth_scenario_tag
