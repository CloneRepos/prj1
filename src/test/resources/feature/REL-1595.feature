@ST_112775 @tagtagtag @this_is_story_tag
...
@SC_482376 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_482377 @third_scenario_tag
...
@SC_482378 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_482379 @fifth_scenario_tag
