@ST_51517 @tagtagtag @this_is_story_tag
...
@SC_244578 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_244579 @third_scenario_tag
...
@SC_244580 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_244581 @fifth_scenario_tag
