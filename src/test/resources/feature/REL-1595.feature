@ST_93650 @tagtagtag @this_is_story_tag
...
@SC_409686 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_409687 @third_scenario_tag
...
@SC_409688 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_409689 @fifth_scenario_tag
