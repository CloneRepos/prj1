@ST_79996 @tagtagtag @this_is_story_tag
...
@SC_354521 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_354522 @third_scenario_tag
...
@SC_354523 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_354524 @fifth_scenario_tag
