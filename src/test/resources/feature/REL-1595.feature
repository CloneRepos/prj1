@ST_64761 @tagtagtag @this_is_story_tag
...
@SC_293535 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_293536 @third_scenario_tag
...
@SC_293537 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_293538 @fifth_scenario_tag
