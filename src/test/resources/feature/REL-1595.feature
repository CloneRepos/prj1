@ST_37292 @tagtagtag @this_is_story_tag
...
@SC_185899 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_185900 @third_scenario_tag
...
@SC_185901 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_185902 @fifth_scenario_tag
