@ST_36448 @tagtagtag @this_is_story_tag
...
@SC_183377 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_183378 @third_scenario_tag
...
@SC_183379 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_183380 @fifth_scenario_tag
