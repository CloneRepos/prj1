@ST_94077 @tagtagtag @this_is_story_tag
...
@SC_410946 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_410947 @third_scenario_tag
...
@SC_410948 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_410949 @fifth_scenario_tag
