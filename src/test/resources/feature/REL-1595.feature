@ST_30277 @tagtagtag @this_is_story_tag
...
@SC_160559 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_160560 @third_scenario_tag
...
@SC_160561 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_160562 @fifth_scenario_tag
