@ST_114859 @tagtagtag @this_is_story_tag
...
@SC_490572 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_490573 @third_scenario_tag
...
@SC_490574 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_490575 @fifth_scenario_tag
