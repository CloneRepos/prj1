@ST_118505 @tagtagtag @this_is_story_tag
...
@SC_504914 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_504915 @third_scenario_tag
...
@SC_504916 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_504917 @fifth_scenario_tag
