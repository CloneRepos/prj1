@ST_39647 @tagtagtag @this_is_story_tag
...
@SC_196758 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_196759 @third_scenario_tag
...
@SC_196760 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_196761 @fifth_scenario_tag
