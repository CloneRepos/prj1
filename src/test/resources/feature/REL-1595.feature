@ST_88968 @tagtagtag @this_is_story_tag
...
@SC_391313 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_391314 @third_scenario_tag
...
@SC_391315 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_391316 @fifth_scenario_tag
