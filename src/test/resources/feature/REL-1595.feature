@ST_45841 @tagtagtag @this_is_story_tag
...
@SC_222564 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_222565 @third_scenario_tag
...
@SC_222566 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_222567 @fifth_scenario_tag
