@ST_73205 @tagtagtag @this_is_story_tag
...
@SC_328836 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_328837 @third_scenario_tag
...
@SC_328838 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_328839 @fifth_scenario_tag
