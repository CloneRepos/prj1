@ST_52163 @tagtagtag @this_is_story_tag
...
@SC_247712 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_247713 @third_scenario_tag
...
@SC_247714 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_247715 @fifth_scenario_tag
