@ST_45267 @tagtagtag @this_is_story_tag
...
@SC_220019 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_220020 @third_scenario_tag
...
@SC_220021 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_220022 @fifth_scenario_tag
