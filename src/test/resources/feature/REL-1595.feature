@ST_123707 @tagtagtag @this_is_story_tag
...
@SC_525347 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_525348 @third_scenario_tag
...
@SC_525349 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_525350 @fifth_scenario_tag
