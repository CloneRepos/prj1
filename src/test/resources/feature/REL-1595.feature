@ST_41038 @tagtagtag @this_is_story_tag
...
@SC_201863 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_201864 @third_scenario_tag
...
@SC_201865 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_201866 @fifth_scenario_tag
