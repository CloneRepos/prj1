@ST_86594 @tagtagtag @this_is_story_tag
...
@SC_381014 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_381015 @third_scenario_tag
...
@SC_381016 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_381017 @fifth_scenario_tag
