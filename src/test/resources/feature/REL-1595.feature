@ST_37714 @tagtagtag @this_is_story_tag
...
@SC_187161 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_187162 @third_scenario_tag
...
@SC_187163 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_187164 @fifth_scenario_tag
