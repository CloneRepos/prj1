@ST_124655 @tagtagtag @this_is_story_tag
...
@SC_528656 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_528657 @third_scenario_tag
...
@SC_528658 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_528659 @fifth_scenario_tag
