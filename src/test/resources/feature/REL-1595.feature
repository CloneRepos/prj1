@ST_84510 @tagtagtag @this_is_story_tag
...
@SC_372818 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_372819 @third_scenario_tag
...
@SC_372820 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_372821 @fifth_scenario_tag
