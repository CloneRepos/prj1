@ST_122144 @tagtagtag @this_is_story_tag
...
@SC_519200 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_519201 @third_scenario_tag
...
@SC_519202 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_519203 @fifth_scenario_tag
