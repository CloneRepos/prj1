@ST_113817 @tagtagtag @this_is_story_tag
...
@SC_486474 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_486475 @third_scenario_tag
...
@SC_486476 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_486477 @fifth_scenario_tag
