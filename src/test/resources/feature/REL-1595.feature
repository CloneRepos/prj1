@ST_56799 @tagtagtag @this_is_story_tag
...
@SC_265236 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_265237 @third_scenario_tag
...
@SC_265238 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_265239 @fifth_scenario_tag
