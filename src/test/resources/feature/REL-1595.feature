@ST_63059 @tagtagtag @this_is_story_tag
...
@SC_288132 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_288133 @third_scenario_tag
...
@SC_288134 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_288135 @fifth_scenario_tag
