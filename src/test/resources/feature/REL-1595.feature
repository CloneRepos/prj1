@ST_46546 @tagtagtag @this_is_story_tag
...
@SC_225362 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_225363 @third_scenario_tag
...
@SC_225364 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_225365 @fifth_scenario_tag
