@ST_66994 @tagtagtag @this_is_story_tag
...
@SC_304016 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_304017 @third_scenario_tag
...
@SC_304018 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_304019 @fifth_scenario_tag
