@ST_116422 @tagtagtag @this_is_story_tag
...
@SC_496719 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_496720 @third_scenario_tag
...
@SC_496721 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_496722 @fifth_scenario_tag
