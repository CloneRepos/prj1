@ST_96060 @tagtagtag @this_is_story_tag
...
@SC_418297 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_418298 @third_scenario_tag
...
@SC_418299 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_418300 @fifth_scenario_tag
