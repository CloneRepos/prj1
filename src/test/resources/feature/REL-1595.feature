@ST_57722 @tagtagtag @this_is_story_tag
...
@SC_268506 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_268507 @third_scenario_tag
...
@SC_268508 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_268509 @fifth_scenario_tag
