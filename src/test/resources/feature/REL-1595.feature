@ST_125680 @tagtagtag @this_is_story_tag
...
@SC_532627 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_532628 @third_scenario_tag
...
@SC_532629 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_532630 @fifth_scenario_tag
