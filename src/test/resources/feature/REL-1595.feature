@ST_69061 @tagtagtag @this_is_story_tag
...
@SC_312530 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_312531 @third_scenario_tag
...
@SC_312532 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_312533 @fifth_scenario_tag
