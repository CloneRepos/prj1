@ST_123186 @tagtagtag @this_is_story_tag
...
@SC_523298 @second_scenario_tag
Scenario: Second scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_523299 @third_scenario_tag
...
@SC_523300 @fourth_scenario_tag
Scenario: Fourth scenario
Some description
Given I created scenario
Then I see it in Relime

@SC_523301 @fifth_scenario_tag
